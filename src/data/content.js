...
export const experience = [
  ...
  },
  {
    ...
    bullets: [
      'Delivered programming lab instruction to 200+ undergrads across Programming Fundamentals, OOP, and Data Structures & Algorithms, designing assignments and assessment criteria.',
      'Mentored students in debugging, code structure, and Git, lifting average lab assessment scores by 30% across the term.',
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      'Built cross-platform Flutter/Dart apps with Firebase backends, REST integrations, Google Maps, and offline storage, taking 5–6 apps from empty repo to store release.',
  ...
  },
  {
    ...
    place: 'Karachi, Pakistan',
    bullets: [
      'Completed a 3-month Flutter development programme, converting UI designs into production screens.',
...
export const projects = [
  ...
  },
  {
    ...
    org: 'Client Project',
    description:
      'Responsive web app simulating an audio/video control interface for the Sereni Elettronica AZIMUT system, with multi-zone A/V management and remote-control actions.',
